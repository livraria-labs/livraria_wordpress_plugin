...
class Livraria_Admin_Page {
    ...
    public function render() {
        ...
        <?php // Handlers moved to assets/admin.js; data provided via wp_localize_script. ?>
        <?php
    }
    ...
    private function render_default_sender_profile_selector($sender_profile) {
        ...
        <?php // Handler moved to assets/admin.js; defaultSenderProfileId provided via wp_localize_script. ?>
        <?php
    }
    ...
    private function render_sender_profiles($sender_profile) {
        ...
        <?php // Modal handlers moved to assets/admin.js. ?>
        <?php
    }
